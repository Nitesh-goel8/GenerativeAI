# 🐱 Cat Breed Classification using PyTorch
...
* Oxford-IIIT Pet Dataset (inspiration for dataset structure): [https://www.robots.ox.ac.uk/~vgg/data/pets/](https://www.robots.ox.ac.uk/~vgg/data/pets/)
